# Lunch-LearnTLSv1.2
TLSv1.2 Demo Project for Lunch and Learn Session
...
5. Form the chain
```bash
cat ca.pem >> fullcertificate.pem
cat cert.pem > fullcertificate.pem
```
...
`openssl pkcs12 -export -out fullcert.p12 -in fullcertificate.pem -inkey cert-key.pem` | PEM to PKCS12
...
- Drag and drop your CA certificate to this directory (in this example ca.pem)
- Double click on the certificate
- Expand the trust section and set SSL to always trust
